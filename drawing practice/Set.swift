...
class Set {
    ...
    private func createEmptyArrayOfCards(){ // fill the cardsOnTable array with cards
        for _ in 0...23{
    ...
    func chooseCard(at index: Int) { // called after the card is touched in the controller
